...
export const SAMPLE_EVENTS: CalendarEvent[] = [
  ...
  },
  {
    id: '5',
    title: 'Conference',
    start: z('2026-06-09T00:00:00Z'),
    end: z('2026-06-12T00:00:00Z'),
    allDay: true,
    status: 'active',
  },
  {
  ...
  },
  {
    id: '7',
    title: 'Holiday',
    start: z('2026-06-19T00:00:00Z'),
    end: z('2026-06-20T00:00:00Z'),
    allDay: true,
    status: 'done',
  },
];
...
export const SAMPLE_JOBS: CalendarEvent[] = [
  ...
  },
  {
    ...
    resourceIds: ['bob'],
    start: z('2026-06-15T14:00:00Z'),
    end: z('2026-06-15T15:30:00Z'),
    status: 'scheduled',
  },
  {
    id: 'j4',
    title: 'Survey — 100 Center',
    resourceIds: ['carol'],
